...
import SoleTraderBVN from './SoleTraderBVN';
import SoleTraderNIN from './SoleTraderNIN';
import SoleTraderProofIdentity from './SoleTraderProofIdentity';

type VerificationType = 'bvn' | 'nin' | 'poi' | undefined;

const SoleTraderIdentityVerfication = ({ next }: { next: () => void }) => {
  ...
  if (verificationType === 'bvn' && !choosenVerificationType)
    return <SoleTraderBVN next={chooseVerificationType} back={back} />;
  if (verificationType === 'nin' && !choosenVerificationType)
    return <SoleTraderNIN next={chooseVerificationType} back={back} />;
  if (verificationType === 'poi' && !choosenVerificationType)
    return (
      <SoleTraderProofIdentity next={chooseVerificationType} back={back} />
    );
...
export default memo(SoleTraderIdentityVerfication);
