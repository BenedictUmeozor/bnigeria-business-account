...
const EmailVerified = () => {
  ...
  const businessStructure = (location.state as LocationState)
    ?.business_structure;
  ...
  }, [businessStructure, navigate]);

  if (!businessStructure) return null;
  ...
  return (
    <section className="ml-auto space-y-6 rounded-xl bg-white p-6 pb-16 shadow-lg lg:max-w-[466px]">
      <div className="flex flex-col items-center justify-center gap-8">
        ...
        <Link to={`/onboarding/${businessStructure}`} className="block w-full">
