import { OnboardingContext } from '@/contexts/corporate-onboarding';
...
const CorporateOnboardingProvider = ({ children }: { children: ReactNode }) => {
...
export default CorporateOnboardingProvider;
