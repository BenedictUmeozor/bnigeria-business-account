...
const NINVerification = ({ next, back }: { next: () => void; back: () => void }) => {
  ...
  return (
    <div className="h-full w-full space-y-8 p-8">
      <header className="space-y-2">
        ...
        <p>Upload your NIN ID card to verify your details</p>
      </header>
      <Form
        layout="vertical"
        autoComplete="off"
      ...
      >
        <div className="grid grid-cols-2 items-start gap-6 gap-y-4 max-lg:grid-cols-1">
          ...
          <Form.Item label="Attached Phone Number" name="phone_number">
            ...
            <p className="mt-1 text-sm text-gray-400">
              This should be the number attached to your NIN
            </p>
          </Form.Item>
        </div>

        <Form.Item label="Upload your NIN Identity card (Front)">
          <div>
            <input
              type="file"
        ...
        <Form.Item label="Upload your NIN Identity card (Back)">
          <div>
            <input
              type="file"
              accept="image/jpeg,image/png,application/pdf"
...
export default memo(NINVerification);
